...
export class CreateZaloOATokenTableOnly1759650000000 implements MigrationInterface {
  name = 'CreateZaloOATokenTableOnly1759650000000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    // Kiểm tra xem bảng đã tồn tại chưa
    const tableExists = await queryRunner.hasTable('zalo_oa_tokens');
    if (!tableExists) {
